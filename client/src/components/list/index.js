                        ...
                        <div className="carousel-item-wrapper">
                            <Slider>
                                            ...
                                            <div className="carousel-content">
                                                ...
                                                <div className="coin-details">
                                                    <span className="coin-img">
                                                        {item.symbol.toLowerCase() === "btc" && (
                                                            <img src={btc} alt="Bitcoin" />
                                                        )}
                                                        {item.symbol.toLowerCase() === "eth" && (
                                                            <img src={eth} alt="Ethereum" />
                                                        )}
                                                        {item.symbol.toLowerCase() === "xrp" && (
                                                            <img src={xrp} alt="XRP" />
                                                        )}
                                                        {item.symbol.toLowerCase() === "ltc" && (
                                                            <img src={ltc} alt="Litecoin" />
                                                        )}
                                                        {item.symbol.toLowerCase() === "bch" && (
                                                            <img src={bch} alt="Bitcoin Cash" />
                                                        )}
                                                        {item.symbol.toLowerCase() === "eos" && (
                                                            <img src={eos} alt="EOS" />
                                                        )}
                                                        ...
                                                        {item.symbol.toLowerCase() === "bsv" && (
                                                            <img src={bsv} alt="Bitcoin SV" />
                                                        )}
                                                        {item.symbol.toLowerCase() === "trx" && (
                                                ...
                                                <div className="coin-stats">
                                                    <span
                                                        className={`coin-one-hour ${item.quote.USD.percent_change_1h > 0
                                                                ? "positive"
                                                                : "negative"
                                                            }`}
                                                    >
                              ...
                              &#37;
                                                    ...
                                                    <span
                                                        className={`coin-one-day ${item.quote.USD.percent_change_24h > 0
                                                                ? "positive"
                                                                : "negative"
                                                            }`}
                                                    >
